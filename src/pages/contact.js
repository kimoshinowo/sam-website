            ...
            <div className="content-highlight margin-bottom">
                ...
                <div className="grid">
                    <div className="grid-item">
                        <a href="https://github.com/samuelchardy" target="_blank">
                    ...
                    <div className="grid-item">
                        <a href="https://www.linkedin.com/in/samuel-chad-hardy/" target="_blank">
                    ...
                    <div className="grid-item">
                        <a href="https://www.researchgate.net/profile/Samuel_Hardy10" target="_blank">
